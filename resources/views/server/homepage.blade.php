...
<div class="relative min-h-screen bg-white dark:bg-gray-800">
    <div id="stats">
            ...
            <div class="max-w-7xl mx-auto py-4 px-4 md:px-6 flex flex-col md:flex-row md:items-center justify-between">
                <div class="flex space-x-8 items-center text-base">
                    <a href="https://expose.dev" class="inline-flex items-center self-start border-0">
                        ...
                        <div class="ml-4"><p
                                    class="text-lg lg:text-3xl tracking-tight text-gray-900 font-bold dark:text-white">
                                Expose</p>
        ...
        <div class="max-w-xl mx-auto rounded-md  mt-32 px-4 py-12 mb-16">
            <h1 class="text-6xl font-extrabold text-center">Welcome to Expose!</h1>

            <div class="gap-x-8 max-w-2xl mx-auto rounded-md bg-gray-50 dark:bg-gray-900/50 text-gray-700 dark:text-gray-200 shadow mt-32 p-12 mb-16">
                    ...
                    <p>
                        The Expose platform at <a href="https://expose.dev">expose.dev</a> is the managed Expose service
                        and
                        gives you a hassle-free
                        experience when sharing your local development environment. We take care of TLS/SSL certificates
                        for
